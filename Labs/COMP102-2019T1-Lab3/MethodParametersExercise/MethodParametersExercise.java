 ...
 *  - drawSignalZeroFlag() draws the flag used by the US navy to signal
...
public class MethodParametersExercise {
     ...
     */
    public void printNameTag(String name, int id){
        UI.println("-------------------------");
        UI.println("Hello");
        UI.println("my name is "+name+". ID: "+id);
        UI.println("-------------------------");

    }

    public void printBottleSong(){
     ...
     */
    public void bottleSongVerse(int verse){
        /*# YOUR CODE HERE */
     ...
     */
    public void drawSignalZeroFlag(){
        //variables
