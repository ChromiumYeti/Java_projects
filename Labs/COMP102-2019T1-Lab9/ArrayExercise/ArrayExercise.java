...
public class ArrayExercise{
    ...
    public void doCountScores(){
        ...
        ArrayList<Integer> scores = this.readAllNumbers("scores.txt");
        /*# YOUR CODE HERE */
     ...
     */
    public ArrayList<Integer> readAllNumbers(String fname){
    ...
    public static void main(String[] args){
        ...
        UI.addButton("Duck Game", ae::doDuckGame);
        UI.addButton("Scores", ae::doCountScores);
