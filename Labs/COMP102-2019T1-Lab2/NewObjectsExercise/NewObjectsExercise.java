 ...
 * - blowUpBalloons() should create two Balloon objects and
...
public class NewObjectsExercise {
    ...
    public void growFlowers(){
        Flower f1 = new Flower (50, 50);
        Flower f2 = new Flower (150, 50);
        Flower f3 = new Flower (250, 50);
        boolean blooming = true;

    }

    /** Creates two Balloon objects and makes them expand and pop */
    public void blowUpBalloons(){
        /*# YOUR CODE HERE */
